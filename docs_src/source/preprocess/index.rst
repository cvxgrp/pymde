...
and processed with faiss. For moderately sized matrices this can still be
efficient, but for very large matrices the conversion can be memory-intensive. Install it with
